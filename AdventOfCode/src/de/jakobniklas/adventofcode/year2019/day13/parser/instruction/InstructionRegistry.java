package de.jakobniklas.adventofcode.year2019.day13.parser.instruction;

import de.jakobniklas.adventofcode.year2019.day13.parser.Memory;
...
public class InstructionRegistry
{
    ...
    public void registerInstruction(Integer opcode, Instruction instruction)
    {
        ...
        {
            instructions.replace(opcode, instruction);
        }
        else
        {
