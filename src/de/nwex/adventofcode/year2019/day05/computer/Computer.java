package de.nwex.adventofcode.year2019.day05.computer;

import de.nwex.adventofcode.year2019.day05.computer.instruction.Instruction;
import de.nwex.adventofcode.year2019.day05.computer.instruction.Parameter;
import de.nwex.adventofcode.year2019.day05.computer.instruction.ParameterMode;

import de.nwex.applicationlib.commonutil.FileUtil;
import de.nwex.applicationlib.commonutil.Log;

import de.nwex.adventofcode.year2019.day05.computer.instruction.impl.AddInstruction;
import de.nwex.adventofcode.year2019.day05.computer.instruction.impl.EqualsInstruction;
import de.nwex.adventofcode.year2019.day05.computer.instruction.impl.JumpIfFalseInstruction;
import de.nwex.adventofcode.year2019.day05.computer.instruction.impl.JumpIfTrueInstruction;
import de.nwex.adventofcode.year2019.day05.computer.instruction.impl.LessThanInstruction;
import de.nwex.adventofcode.year2019.day05.computer.instruction.impl.MultiplyInstruction;
import de.nwex.adventofcode.year2019.day05.computer.instruction.impl.OutputInstruction;
...
public class Computer
{
     ...
     */
    public Computer(String path, Integer mode)
    {
        this(Arrays.stream(FileUtil.getTextContent(path).replace("\n", "").split(",")).map(Integer::parseInt).collect(Collectors.toList()), mode);
    }
     ...
     */
    public Computer(List<Integer> input, Integer mode)
    {
        ...
        registerInstruction(3, new Instruction(1, (parameters) -> setValue(parameters.get(0).getValue(), mode)));
